...
export default function Home() {
  ...
  return (
    ...
    <div>
      <div>
        <div className="sm:text-4xl md:leading-tight md:text-5xl lg:leading-tight lg:text-6xl font-bold sm:w-full md:w-7/8 xl:w-3/4">
        ...
        <div className="grid 2xl:grid-cols-3 gap-8">
          ...
          <div className="grid grid-cols-2 2xl:grid-cols-1">
            <div className="mt-8 w-full h-80 relative group">
              <div className="h-80 -left-6 -top-6 rounded-lg">
                <div className="h-full relative z-20">
                  <Image
                    className="rounded-lg h-full object-cover grayscale-50 group-hover:grayscale-0 duration-1000 "
                    src="/KeithSmall.jpg"
                    height={200}
                    width={420}
                    alt="profile pic">
                ...
                {/* <div className="inline-block absolute top-5 left-5 h-[320px] w-[420px] border-4 border-cyan-500 rounded-lg group-hover:translate-x-3 group-hover:translate-y-3 transition-transform duration-300"></div> */}
              </div>
            </div>
          </div>
        ...
        <div className="hidden 2xl:inline-flex pt-12 sm:text-sm md:text-md lg:text-lg uppercase text-cyan-500 tracking-tight">
